...
interface SortableStatusItemProps {
  ...
  onEdit: (status: RescisaoStatus) => void;
  onDeleteClick: (status: RescisaoStatus) => void;
}
...
interface RescisaoStatusListProps {
  statuses: RescisaoStatus[];
  onEdit: (status: RescisaoStatus) => void;
  onDelete: (id: string) => void;
  onReorder: (statuses: RescisaoStatus[]) => void;
}

export function RescisaoStatusList({ statuses, onEdit, onDelete, onReorder }: RescisaoStatusListProps) {
  const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
  const [statusToDelete, setStatusToDelete] = useState<RescisaoStatus | null>(null);
  ...
  const handleDeleteClick = (status: RescisaoStatus) => {
